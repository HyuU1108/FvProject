...
<div id="map">
    ...
    <div class="flight-image-container">
            <img id="flight-image" src="" alt="비행기 사진">
        </div>
...
<script>
    ...
    var flightInfoTableBody = document.querySelector('#flight-info-container .flight-info-table tbody');
     var flightImage = document.getElementById('flight-image'); // 이미지 요소
                                 ...
                                 marker.on("click", function (e) {
                                   ...
                                   updateTable(flightInfo);
                                    flightInfoContainer.style.display = 'block';
                                     var imageUrl = "/resources/img/nophoto.png";
                                      if (callsign !== null && callsign !== undefined && callsign !== "") {
                                        imageUrl = "https://photos.flightradar24.com/api/v1/aircraft/" + planeId + "?size=medium";
                                      }
                                      flightImage.src = imageUrl;
                                      flightImage.alt = callsign + " 사진";
    ...
    map.on("click", function () {
     ...
     flightInfoContainer.addEventListener('click', function(event){
